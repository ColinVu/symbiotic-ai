...
docker-compose run --rm symbiotic-ai python -m symbiote.cli.main train-hmm \
    --videos /data/videos/video1.mp4 /data/videos/video2.mp4 \
    --annotations /data/annotations/video1.csv /data/annotations/video2.csv \
...
docker run --rm -it \
    ...
    symbiotic-ai:latest \
    python -m symbiote.cli.main train --video /data/videos/IMG_5293.mov --label "apple"
```
...
2. Run a simple test: `docker-compose run --rm symbiotic-ai python -m symbiote.cli.main --help`
