...
class ArucoDetector:
    ...
    def __init__(self, aruco_dict_type: str = "DICT_4X4_1000",
                 distance_decay: float = 5.0):
        """Initialise ARUCO detector.

        Args:
            aruco_dict_type: Name of the ARUCO dictionary (e.g. "DICT_4X4_1000" for IDs 0-999).
            distance_decay: Controls how fast weight decays with distance.
        """
        cv_dict_id = _ARUCO_DICT_MAP.get(aruco_dict_type, cv2.aruco.DICT_4X4_1000)
