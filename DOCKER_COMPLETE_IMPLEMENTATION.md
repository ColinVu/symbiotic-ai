...
Instead of:
```powershell
python -m symbiote.cli.main train --video ../videos/video.mp4 --label "apple"
```
...
2. Run: `docker-compose run --rm symbiotic-ai python -m symbiote.cli.main train --video /data/videos/test.mp4 --label "apple"`
